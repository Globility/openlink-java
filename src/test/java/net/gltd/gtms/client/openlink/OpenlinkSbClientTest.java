...
public class OpenlinkSbClientTest extends XmlTest {
...
//	private static final String SYSTEM_AND_DOMAIN = SYSTEM + "." + DOMAIN;
	...
	private static final String SYSTEM_AND_DOMAIN = "jakob@" + DOMAIN + "/office" ;

	private static final String DESTINATION = "50203";

	private OpenlinkClient client = null;

	public OpenlinkSbClientTest() throws JAXBException, XMLStreamException {
